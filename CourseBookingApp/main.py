...
@app.get("/courses", response_class=HTMLResponse, response_model=None)
async def test(db: Session, request: Request):
    course_list = db.query(models.Courses).filter(models.Courses.id == 0)
